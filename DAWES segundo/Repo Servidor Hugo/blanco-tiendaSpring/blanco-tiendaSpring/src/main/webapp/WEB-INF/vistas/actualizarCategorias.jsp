...
<h3> Modificación de categorias</h3>
	<div class= "form">
		<form action="http://localhost:8080/tienda/categorias/formularioactualizarcategoria" method ="POST">
...
<c:forEach items="${lista}" var="categoria">
	 ...
	 <div class="form">
	 	<form action="http://localhost:8080/tienda/categorias/actualizarcategoria" method="POST" >
