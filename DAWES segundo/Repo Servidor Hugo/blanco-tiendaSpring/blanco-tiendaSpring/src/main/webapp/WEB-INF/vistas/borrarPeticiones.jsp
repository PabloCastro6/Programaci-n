...
<h3> Borrar Categorias</h3>
	<div class= "form">
		<form action="http://localhost:8080/tienda/peticiones/formularioborrarpeticiones" method ="POST" id="formulario">
...
<c:forEach items="${lista}" var="peticion">
	 ...
	 <div class="form">
	 	<form action="http://localhost:8080/tienda/peticiones/borrarpeticiones" method="POST" >
	 		 ...
	 		 <label for="idClien"> ID Peticion</label>
			<input type ="text" id="idClien" name="idClien" value="${peticion.id}" readonly><br>
