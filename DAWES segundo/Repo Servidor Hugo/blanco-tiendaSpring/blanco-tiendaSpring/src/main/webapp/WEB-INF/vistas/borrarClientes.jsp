	 ...
	 <div class="form">
	 	<form action="http://localhost:8080/tienda/clientes/borrarclientes" method="POST" >
	 		...
	 		<label for="idClien">Id Cliente</label> 
				<input type="text" id="idClien" value="${cliente.id}" readonly name="idClien"> 
				<br>
				<label for="name">Nombre</label>
				<input type="text" id="name" value="${cliente.nombre}" readonly name="name"> 
				<br>
				<label for="correoElec">Correo Electronico</label>
				<input type="text" id="correoElec" value="${cliente.correo}" readonly name="correoElec"> 
				<br>
				...
				<input type="checkbox" id="activ" value="${cliente.activo}" name="activ"  readonly>
				<br>
