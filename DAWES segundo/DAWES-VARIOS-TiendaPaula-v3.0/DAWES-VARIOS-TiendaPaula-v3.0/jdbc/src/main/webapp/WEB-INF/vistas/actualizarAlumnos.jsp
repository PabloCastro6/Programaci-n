...
<body>
	...
	<h3> Modificación de Alumnos </h3>
		<div class="form">
			<form action="http://localhost:8080/colegio/alumnos/formularioactualizaralumno"
		...
		<c:forEach items="${lista}" var="alumno">
			...
			<div class="form">
				...
				<form action="http://localhost:8080/colegio/alumnos/actualizaralumno" method="POST" id="formulario">
