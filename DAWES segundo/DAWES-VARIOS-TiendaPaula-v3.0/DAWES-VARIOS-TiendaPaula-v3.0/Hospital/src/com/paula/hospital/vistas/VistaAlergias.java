...
import com.paula.hospital.controllers.AlergiasController;
import com.paula.hospital.dtos.AlergiaDTO;
...
public class VistaAlergias {
	...
	public void menuActualizarAlergia() throws ClassNotFoundException, SQLException {
		...
		System.out.println("Introduzca por favor el ID de alergia a actualizar (Obligatorio): ");
