...
<div class = "container">
	...
	<div class = "form">
		...
		<form action = "http://localhost:8080/tienda/categorias/formularioborrarcategorias" method = "POST">
	...
	<c:forEach items ="${lista}" var ="categoria">
		...
		<div class="form">
			<form action ="http://localhost:8080/tienda/categorias/borrarcategorias" method="POST">
