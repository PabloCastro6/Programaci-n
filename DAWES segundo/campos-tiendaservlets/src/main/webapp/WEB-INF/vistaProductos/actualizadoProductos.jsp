...
<div class="container">
		...
		<div class="form">
			<form action="http://localhost:8080/tienda/productos/formularioactualizarproducto" method="POST">
	...
	<c:forEach items="${lista}" var="producto">
		...
		<div class="form">
			<form action="http://localhost:8080/tienda/productos/actualizarproducto" method="POST">
